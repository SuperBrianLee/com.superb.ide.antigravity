...
{
	internal class AntigravityForWindowsInstallation : AntigravityInstallation
	{
		...
		public static bool TryDiscoverInstallation(string editorPath, out IAntigravityInstallation installation)
		{
			...
			installation = new AntigravityForWindowsInstallation()
			{
...
#pragma warning disable CS0649
		...
		internal class VsWhereResult
		{
			...
			public IEnumerable<AntigravityInstallation> ToAntigravityInstallations()
			{
				foreach (var entry in entries)
				{
					yield return new AntigravityForWindowsInstallation
					{
...
#pragma warning restore CS3021
		...
		private static IEnumerable<AntigravityInstallation> QueryVsWhere()
		{
			var progpath = _vsWherePath;

			if (string.IsNullOrWhiteSpace(progpath))
				return Enumerable.Empty<AntigravityInstallation>();
		...
		private static IEnumerable<AntigravityInstallation> QueryVsWhere(string progpath, string arguments)
		{
